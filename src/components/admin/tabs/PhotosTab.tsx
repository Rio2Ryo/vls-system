        ...
        >
          {uploading ? (
            <>
              ...
              <p className="text-[10px] text-gray-400 mt-2">HuggingFaceにアップロード＆顔検出を実行中</p>
            </>
          ) : (
            <>
              ...
              <p className="text-[10px] text-gray-400">HuggingFaceに保存されます</p>
            </>
          )}
          <input
      ...
      <Card>
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-400">HuggingFaceから画像を読み込んでいます...</p>
          </div>
        ) : imageNames.length === 0 ? (
